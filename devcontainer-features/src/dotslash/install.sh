...
download() {
  local version="$1"
  local url="https://github.com/facebook/dotslash/releases/download/${version}/dotslash-linux-musl.$(uname -m).${version}.tar.gz"
  ...
  # Download and untar
  echo "Installing dotslash version ${version} to /usr/loca/bin..."
